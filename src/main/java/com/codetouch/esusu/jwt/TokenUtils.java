package com.codetouch.esusu.jwt;
...
import com.codetouch.esusu.login.Login;
...
public class TokenUtils {
    ...
    public static String generateJWT(String userName, String owner) {
   
        long currentTimeInSecs = currentTimeInSecs();
        long exp= currentTimeInSecs + 900;
